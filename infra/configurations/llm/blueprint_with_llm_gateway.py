...
llm_registered_model = datarobot.RegisteredModel(
    resource_name=f"Talk to My Docs LLM Registered Model [{PROJECT_NAME}]",
    custom_model_version_id=llm_custom_model.version_id,
    name=f"Talk to My Docs LLM Registered Model [{PROJECT_NAME}]",
    use_case_ids=[use_case.id],
)

# Deploy the registered model
llm_deployment = datarobot.Deployment(
    resource_name=f"Talk to My Docs LLM Blueprint Deployment [{PROJECT_NAME}]",
    registered_model_version_id=llm_registered_model.version_id,
    prediction_environment_id=prediction_environment.id,
    label=f"Talk to My Docs LLM Blueprint Deployment [{PROJECT_NAME}] "
    + llm_resource_name,
    use_case_ids=[use_case.id],
